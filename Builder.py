...
file_excludes = [
    'Qt6WebEngineCore.dll', 'lupdate.exe', 'Qt6Designer.dll',
    'Qt6Quick.dll', 'Qt6DesignerComponents.dll', 'qtwebengine_devtools_resources.pak',
    'qtwebengine_resources.pak', 'Qt6Qml.dll', 'Qt6QuickTemplates2.dll',
...
app_name = f'PyAdhan v{config.APP_VERSION}'
...
output_path = Path(__file__).parent / f'build/{app_name}'
